export const es = {
  ...
  cont: {
    ...
    phoneError: 'El teléfono no es válido para el país seleccionado.',
    phoneT: 'Teléfono',
    emailT: 'Email',
    waT: 'WhatsApp',
    hoursT: 'Horario',
...
export const en = {
  ...
  cont: {
    ...
    phoneError: 'The phone number is not valid for the selected country.',
    phoneT: 'Phone',
    emailT: 'Email',
    waT: 'WhatsApp',
    hoursT: 'Hours',
